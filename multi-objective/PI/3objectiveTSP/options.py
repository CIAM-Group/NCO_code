...
def get_options(args=None):
    ...
    parser.add_argument('--rollout_enable', action='store_true', default=True,
    ...
    parser.add_argument('--init_method', default='ngreedy',
                        help='greddy or stomatic')

    parser.add_argument('--init_type', default='ngreedy', help='Population type')
    parser.add_argument('--population_size', type=int, default=91, help='Random solution num')
    parser.add_argument('--vector_init_num', type=int, default=91, help='Random n_vec num')
    ...
    parser.add_argument('--checkpoint_inference', default='totsp40.pt', help='Path to load model parameters and optimizer state from')
    parser.add_argument('--solution_inference', default='datasets/totsp100_100p.npy', help='Path to load model parameters and optimizer state from')
    parser.add_argument('--dataset_inference', default='datasets/TOTSP40-1000instances.npy', help='Path to load model parameters and optimizer state from')
    ...
    parser.add_argument('--T_train', type=int, default=16)
    ...
    parser.add_argument('--best_prevent', type=int, default=1,
                        help='Number of prevent (1)')
    parser.add_argument('--val_size', type=int, default=1000,
                        help='Number of instances used for reporting validation performance')
    parser.add_argument('--eval_batch_size', type=int, default=1000,
                        help="Batch size to use during (baseline) evaluation")

    parser.add_argument('--num_obj', type=int, default=3, help="the number of target")
