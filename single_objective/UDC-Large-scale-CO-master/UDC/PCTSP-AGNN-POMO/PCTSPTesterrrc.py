...
from PCTSPEnv import PCTSPEnv as Env
from PartitionModel import PartitionModel as PartitionModel
from PCTSPModel import PCTSPModel as Model
...
class PCTSPTrainerPartition:
    ...
    def _test_one_batch(self, solution_gnn, data, batch_size, episode, k):
        ...
        first = first.min(-1)[0]
        self.env.load_problems(new_batch_size, tsp_insts_now, first, last, collected_prize, depot_flag_now)
