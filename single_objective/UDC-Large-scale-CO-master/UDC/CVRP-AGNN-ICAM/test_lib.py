...
from CVRPTesterlib import CVRPLiber as Trainer
...
trainer_params = {
    ...
    'validation_test_episodes': 1, # size of the test set, should be 1
    'validation_test_batch_size': 1, # batch size of testing, should be 1
