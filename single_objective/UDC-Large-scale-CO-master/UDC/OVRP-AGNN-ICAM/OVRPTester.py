...
from OVRProblemDef import get_random_problems, augment_xy_data_by_8_fold
import random
...
class OVRPTester:
    ...
    def _test_one_batch(self, solution_gnn, solution_gnn_flag, data, demand, batch_size, episode, k):
        ...
        # self.env.cal_leagal_2dim(now_problem[:, :, -1], solution.squeeze(0), solution_flag.squeeze(0))
