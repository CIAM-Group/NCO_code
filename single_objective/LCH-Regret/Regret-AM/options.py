...
def get_options(args=None):
    ...
    parser.add_argument('--batch_size', type=int, default=50, help='Number of instances per batch during training')
    ...
    parser.add_argument('--val_dataset', type=str, default='./vrp50.pkl', help='Dataset file to use for validation')
    ...
    parser.add_argument('--eval_only', action='store_true', default=True, help='Set this value to only evaluate model')
    ...
    parser.add_argument('--load_path', default='CVRP50.pt',help='Path to load model parameters and optimizer state from')
