...
import os
import pickle
from problems.fmdvrp.state_fmdrvp import State_FMDVRP
...
class FMDVRP(object):
    ...
    def make_dataset(*args, **kwargs):
        return FMDVRPDataset(*args, **kwargs)

    @staticmethod
    def make_state(*args, **kwargs):
        return State_FMDVRP.initialize(*args, **kwargs)
...
class FMDVRPDataset(Dataset):

    def __init__(self, filename=None, size=50, num_samples=1000000, offset=0, distribution=None):
        super(FMDVRPDataset, self).__init__()
