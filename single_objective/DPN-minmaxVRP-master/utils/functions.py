...
def load_problem(name):
    ...
    from problems import MPDP
    from problems import MDVRP
    from problems import FMDVRP
    problem = {
        'mtsp': MTSP,
        'mpdp': MPDP,
        'mdvrp': MDVRP,
...
def load_model(path, agent_num=3, ft="N", epoch=None):
