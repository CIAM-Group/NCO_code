...
def get_options(args=None):
    ...
    parser.add_argument('--val_dataset', type=str, default='data/mtsp/mtsp100_test_seed3333.pkl', help='Dataset file to use for validation')
    parser.add_argument('--val_dataset2', type=str, default='data/mtsp/mtsp200_test_seed3333.pkl', help='Dataset file to use for validation')
    parser.add_argument('--validate_size2', type=int, default=200, help="The size of the problem graph")
    parser.add_argument('--val_dataset3', type=str, default='data/mtsp/mtsp500_test_seed3333.pkl', help='Dataset file to use for validation')
    ...
    parser.add_argument('--agent_list', default=[3, 5, 7, 10], help="Number of M in evaluation")
    ...
    parser.add_argument('--load_path', help='Path to load model parameters and optimizer state from') # , default='pretrained/mtsp/mtsp100/mTSP-100.pt'
