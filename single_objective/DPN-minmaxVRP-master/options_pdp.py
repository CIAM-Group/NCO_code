...
def get_options(args=None):
    ...
    parser.add_argument('--val_dataset', type=str, default='data/mpdp/mpdp100_test_seed3333.pkl', help='Dataset file to use for validation')
    parser.add_argument('--val_dataset2', type=str, default='data/mpdp/mpdp200_test_seed3333.pkl', help='Dataset file to use for validation')
    parser.add_argument('--validate_size2', type=int, default=200, help="The size of the problem graph")
    parser.add_argument('--val_dataset3', type=str, default='data/mpdp/mpdp500_test_seed3333.pkl', help='Dataset file to use for validation')
    ...
    # Misc
    parser.add_argument('--run_name', default='run_pdp', help='Name to identify the run')
